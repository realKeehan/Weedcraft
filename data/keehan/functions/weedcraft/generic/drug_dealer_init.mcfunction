## Configure a wandering trader to act as the Weedcraft drug dealer
    ...
    summon minecraft:firework_rocket ~ ~1 ~ {Life:0,LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;5635925]}]}}}}
