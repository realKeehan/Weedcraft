## Apply blunt effects to the player and revoke the advancement
    #> Called by the "keehan:utils/player_ate_blunt" advancement
    ...
    # Revoke the "keehan:utils/player_ate_blunt" advancement
    advancement revoke @s only keehan:utils/player_ate_blunt
