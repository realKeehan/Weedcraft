## Apply cocaine effects to the player and revoke the advancement
    #> Called by the "keehan:utils/player_ate_cocaine" advancement
    ...
    # Revoke the "keehan:utils/player_ate_cocaine" advancement
    advancement revoke @s only keehan:utils/player_ate_cocaine
