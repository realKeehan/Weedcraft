## Apply mixed shrooms effects to the player and revoke the advancement
    #> Called by the "keehan:utils/player_ate_mixed_shrooms" advancement
    ...
    # Revoke the "keehan:utils/player_ate_mixed_shrooms" advancement
    advancement revoke @s only keehan:utils/player_ate_mixed_shrooms
