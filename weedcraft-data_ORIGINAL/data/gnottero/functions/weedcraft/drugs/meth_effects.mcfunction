## Apply meth effects to the player and revoke the advancement
    #> Called by the "gnottero:utils/player_ate_meth" advancement
    ...
    # Revoke the "gnottero:utils/player_ate_meth" advancement
    advancement revoke @s only gnottero:utils/player_ate_meth
